...
void wine()
{
    ...
    fp=fopen(strcat(temp,"wine.test.3.txt"),"r");
    ...
    if(fp!=NULL)
    {
        ...
        fpt[0]=fopen(strcat(temp,"wine.test.3.txt"),"r");
        strcpy(temp,PATH);
        fpt[1]=fopen(strcat(temp,"wine.train.txt"),"r");
   ...
   // int noOfDimension=4;
    ...
    if(fp!=NULL)
    {
        ...
        for(l=0;l<2;l++)
        {
            ...
            cout<<"Actual\\\t\tPredicted Classes"<<endl;
            cout<<"Classes\\";
            cout<<endl;
            for(i=0;i<=noOfClasses;i++)
            if(i==0)
